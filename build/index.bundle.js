...
var _Polyline = require('ol/format/Polyline.js');
...
var _BingMaps = require('ol/source/BingMaps.js');

var _BingMaps2 = _interopRequireDefault(_BingMaps);

var _Vector = require('ol/source/Vector.js');
...
var routeFeature = new _Feature2.default({
  type: 'route',
  geometry: route
});
var geoMarker = new _Feature2.default({
  type: 'geoMarker',
  geometry: new _Point2.default(routeCoords[0])
});
var startMarker = new _Feature2.default({
  type: 'icon',
  geometry: new _Point2.default(routeCoords[0])
});
var endMarker = new _Feature2.default({
  type: 'icon',
  geometry: new _Point2.default(routeCoords[routeLength - 1])
});
...
var moveFeature = function moveFeature(event) {
  ...
  if (animating) {
    ...
    var currentPoint = new _Point2.default(routeCoords[index]);
    var feature = new _Feature2.default(currentPoint);
